...
function! spaceline#colorscheme#solarized_dark#solarized_dark()
    ...
    if get(g:,'spaceline_seperate_style', 'arrow') == 'slant'
        call spaceline#spaceline#SpaceHL('HomeModeRight',s:slc,  'green', 'blue')
        call spaceline#spaceline#SpaceHL('FileNameRight',s:slc, 'green','blue')
        call spaceline#spaceline#SpaceHL('FileSizeRight',s:slc, 'green','base03')
        call spaceline#spaceline#SpaceHL('GitLeft',s:slc,  'green',  'base03')
    ...
    elseif get(g:,'spaceline_seperate_style', 'arrow') == 'arrow-fade'
        call spaceline#spaceline#SpaceHL('HomeModeRight',s:slc,  'green', 'blue')
        call spaceline#spaceline#SpaceHL('FileNameRight',s:slc, 'blue','green')
        call spaceline#spaceline#SpaceHL('FileSizeRight',s:slc, 'green','base03')
        call spaceline#spaceline#SpaceHL('GitLeft',s:slc,  'base03',  'green')
        call spaceline#spaceline#SpaceHL('Gitright',s:slc,  'green',  'base03')
    else
        call spaceline#spaceline#SpaceHL('HomeModeRight',s:slc,  'blue', 'green')
        call spaceline#spaceline#SpaceHL('FileNameRight',s:slc, 'blue','green')
        call spaceline#spaceline#SpaceHL('FileSizeRight',s:slc, 'base03','green')
        call spaceline#spaceline#SpaceHL('GitLeft',s:slc,  'base03',  'green')
        call spaceline#spaceline#SpaceHL('Gitright',s:slc,  'base03',  'green')
    endif
    call spaceline#spaceline#SpaceHL('FileName', s:slc, 'base03', 'blue')
    call spaceline#spaceline#SpaceHL('Filesize', s:slc, 'base03', 'green')
    call spaceline#spaceline#SpaceHL('HeartSymbol', s:slc, 'green',  'base03')
    call spaceline#spaceline#SpaceHL('CocError',s:slc,  'red',  'base03')
    call spaceline#spaceline#SpaceHL('CocWarn',s:slc,  'blue',  'base03')
    ...
    if get(g:,'spaceline_seperate_style', 'arrow') == 'arrow-fade'
        call spaceline#spaceline#SpaceHL('LineFormatRight',s:slc,  'base03',  'green')
    else
        call spaceline#spaceline#SpaceHL('LineFormatRight',s:slc,  'green',  'base03')
    endif
    ...
    call spaceline#spaceline#SpaceHL('StatusLineinfo',s:slc,  'cyan',  'base03')
    call spaceline#spaceline#SpaceHL('EndSeperate',s:slc,  'base03',  'green')
    call spaceline#spaceline#SpaceHL('VimMode',s:slc,  'green',  'base03')

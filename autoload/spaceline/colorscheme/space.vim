...
function! spaceline#colorscheme#space#space()
    ...
    call spaceline#spaceline#SpaceHL('GitAdd',s:slc,  'lightgray',  'green')
    call spaceline#spaceline#SpaceHL('GitRemove',s:slc,  'lightgray',  'red')
    call spaceline#spaceline#SpaceHL('GitModified',s:slc,  'lightgray',  'lightblue')

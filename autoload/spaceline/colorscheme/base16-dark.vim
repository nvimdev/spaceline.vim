" =============================================================================
" Filename: base16-dark.vim
" Author: taigacute
" URL: https://github.com/taigacute/spaceline.vim
" License: MIT License
" =============================================================================
let s:slc={}
let s:slc.base_red = ['ab4642', 214]
let s:slc.black = ['000000', 0]
let s:slc.lightgray= ['d7d7d7', 188]
let s:slc.purple = ['ba8baf', 261]
...
function! spaceline#colorscheme#base16-dark#base16-dark()
    call spaceline#spaceline#SpaceHL('HomeMode', s:slc, 'black', 'base_red')
    if get(g:,'spaceline_seperate_style', 'arrow') == 'slant'
        call spaceline#spaceline#SpaceHL('HomeModeRight',s:slc,  'base_red', 'black')
    ...
    elseif get(g:,'spaceline_seperate_style', 'arrow') == 'arrow-fade'
        ...
        call spaceline#spaceline#SpaceHL('HomeModeRight',s:slc,  'black', 'base_red')
        call spaceline#spaceline#SpaceHL('FileNameRight',s:slc, 'black','purple')
    ...
    if get(g:,'spaceline_seperate_style', 'arrow') == 'arrow-fade'
        call spaceline#spaceline#SpaceHL('LineFormatRight',s:slc,  'black',  'purple')
    else
    ...
    call spaceline#spaceline#SpaceHL('EndSeperate',s:slc,  'darkpurple',  'base_red')
